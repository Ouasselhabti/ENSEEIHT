...
public class ServerObject {
	...
	public boolean contain_sub(Client_itf client) {
		return subs_clients.contains(client);
	}
	...
	public synchronized void notifySubscribers(Client_itf client2, Object obj2) throws RemoteException {
		for (Client_itf client : subs_clients) {
			if (!client.equals(client2))
				client.notifyCallback(obj2,this.id);
		}
	}
