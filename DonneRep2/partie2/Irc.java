...
public class Irc extends Frame {
	...
	public Irc(SharedObject s) {
		...
		Button read_light_button = new Button("read_light");
		read_light_button.addActionListener(new readLightListener(this));
		add(read_light_button);
...
class writeListener implements ActionListener {
	...
	class readLightListener implements ActionListener {
		Irc irc;
		public readLightListener (Irc i) {
			irc = i;
		}
		public void actionPerformed (ActionEvent e) {
			...
			// display the read value
			irc.text.append("Automatically read from cach:  "+s+"\n");
		}
	}
