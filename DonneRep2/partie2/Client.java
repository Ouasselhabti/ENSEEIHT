...
public class Client extends UnicastRemoteObject implements Client_itf {
	...
	public void notifyCallback(Object obj,int id) {
		SharedObject_itf so = sharedObjects.get(id);
		so.setObj(obj);
	...
	public static boolean isSubscribed(int id) throws RemoteException {
		return server.isSubscribed(client,id);
	}
}
