...
public class ServerObject {
	...
	public synchronized void notifySubscribers() throws RemoteException {
		for (Client_itf client : subs_clients) {
			client.notifyCallback();
		}
	}

	public void notifySubs(int id) throws RemoteException {
			// On met à jour la copie locale de chaque client abonné
			for (Client_itf subscriber : subs_clients) {
				subscriber.getLocalVersion(id);
			}
	}
